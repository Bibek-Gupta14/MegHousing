...
![MegHousing Banner](images/banner.png)
...
![System Architecture Flowchart](images/flowcharts/system-architecture.png)

The MegHousing Portal utilizes a lightweight, client-side architecture designed for:

- **Minimal dependencies** - Pure HTML, CSS, and JavaScript
- **High availability** - No complex backend dependencies
- **Optimal performance** - Fast load times across all connection speeds
- **Maximum accessibility** - Semantic markup and WCAG 2.1 AA compliance

### User Journey Flowchart

![User Journey Flowchart](images/flowcharts/user-journey.png)

Citizens navigate through an intuitive interface designed around their needs:

1. Homepage → Service Discovery
2. Service Selection → Scheme Information
3. Application Process → Support Resources
